            ...
            <div className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                    <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
                        <div className="lg:pr-4">
                            <div className="lg:max-w-lg">
                                ...
                                <p className="mt-6 text-xl leading-8 text-main-bg-color">
                                {t("Enretag LLC is an excellent choice for your business due to many advantages:")}
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className="-ml-12 -mt-12 p-12 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden">
                        <img
                            alt=""
                            src="/images/service_pages/wholesale-service-11.jpg"
                            ...
                            <div className="max-w-xl  leading-7 text-main-bg-color lg:max-w-lg">
                                <ul role="list" className="mt-8 space-y-8 text-gray-600">
                                    <li className="flex gap-x-3 text-main-bg-color">
                                        ...
                                        <span>
                                            <strong className="font-semibold text-amber-500">{t("The automatic warehouse management system")}</strong> {t("enables efficient management of storage and delivery of goods, reducing logistics time and costs.")}
                                        </span>
                                    </li>
                                    <li className="flex gap-x-3 text-main-bg-color">
                                        <CheckBadgeIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-main-bg-color" />
                                        <span>
                                            <strong className="font-semibold text-amber-500">{t("Integration")}</strong> {t("with popular e-commerce platforms (Amazon, Walmart, Etsy, eBay, Shopify, WooCommerce) allows quick and easy access to sales and inventory data through Enretag LLC software automation, making it affordable for small and medium-sized businesses.")}
                                        </span>
                                    </li>
                                    <li className="flex gap-x-3 text-main-bg-color">
                                        <CheckBadgeIcon aria-hidden="true" className="mt-1 h-5 w-5 flex-none text-main-bg-color" />
                                        <span>
                                            <strong className="font-semibold text-amber-500">{t("With its extensive storage capacity")}</strong> {t("and the privilege of fast delivery to customers, Enretag LLC becomes an ideal solution for wholesalers and online stores.")}
